...
public class CacheImplWithoutLoader extends AbstractCache {

  private Cache<String, Set<Long>> cache;
  private Timer timer;
  private boolean update = false;

  public CacheImplWithoutLoader(Map<String, Set<Long>> inputData, Map<String, Set<Long>> updateData)
  ...
  public boolean hasValueForKey(String key, Long value) {
    return cache.getIfPresent(key).contains(value);
  }
